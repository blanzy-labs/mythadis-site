...
Mythadis is an independent game studio. The approved identity is **MYTHADIS / Games for Worlds Unbound**. The current baseline is deliberately minimal; final visual design arrives in later slices.
